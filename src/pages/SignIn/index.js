        ...
        <View style={{ backgroundColor: '#3F5C57', flex: 1 }}>
            <KeyboardAvoidingView behavior="position" enabled>
                ...
                <View>
                    ...
                    <TouchableOpacity style={styles.BotaoAcessoSenha} onPress={() => navigation.navigate('SignUp',
                        alert('Para ter acesso ao aplicativo fale com algum dos administradores'))}>
